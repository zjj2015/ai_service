...
public class ExcelUtil {
	 ...
	 *             异常
	 */
	public static <T> void listToExcel(List<T> list, LinkedHashMap<String, String> fieldMap, String sheetName, int sheetSize, OutputStream out) throws CustomException {
	 ...
	 *             异常
	 */
	public static <T> void listToExcel(List<T> list, LinkedHashMap<String, String> fieldMap, String collectionName, String title, String content, String sheetName, int sheetSize, OutputStream out) throws CustomException {
	 ...
	 *             异常
	 */
	public static <T> void listToExcel(List<T> list, LinkedHashMap<String, String> fieldMap, String sheetName, OutputStream out) throws CustomException {
	 ...
	 *             异常
	 */
	public static <T> void listToExcel(List<T> list, LinkedHashMap<String, String> fieldMap, String sheetName, int sheetSize, HttpServletResponse response, String fileName) throws CustomException {
	 ...
	 *             异常
	 */
	public static <T> void listToExcel(List<T> list, LinkedHashMap<String, String> fieldMap, String collectionName, String title, String content, String sheetName, int sheetSize, HttpServletResponse response, String fileName) throws CustomException {
	 ...
	 *             异常
	 */
	public static <T> void listToExcel(List<T> list, LinkedHashMap<String, String> fieldMap, String sheetName, int sheetSize, HttpServletResponse response) throws CustomException {
	 ...
	 *             异常
	 */
	public static <T> void listToExcel(List<T> list, LinkedHashMap<String, String> fieldMap, String collectionName, String title, String content, String sheetName, HttpServletResponse response) throws CustomException {
	 ...
	 *             异常
	 */
	public static <T> void listToExcel(List<T> list, LinkedHashMap<String, String> fieldMap, String sheetName, HttpServletResponse response) throws CustomException {
	 ...
	 *             异常
	 */
	public static <T> void leadToExcelQuestionBankTemplet(LinkedHashMap<String, String> fieldMap, String sheetName, HttpServletResponse response) throws CustomException {
	 ...
	 *						3、throw new ExcelException("3," + (col + 1) + "," + (i + 1)) 必填列无数据时抛出 (col+1)行  (i+1)列					
	 * @作者:牛文钻
	 * @编写日期:2016-12-12
	 */
	public static <T> List<T> excelToList(InputStream in, int sheetName, Class<T> entityClass, LinkedHashMap<String, String> fieldMap, boolean uniqueField, String[] uniqueFields, int frontRow) throws Exception {
		...
		if (uniqueField){
			...
			for (int i = 1; i < realRows; i++) {
				...
				if (nullCols == uniqueFields.length) {
					throw new CustomException("2," + repeat);
				}
			}
		}
		// 将sheet转换为list
		for (int i = 2; i < realRows + 2; i++) {
			// 新建要转换的对象
			...
			for (Entry<String, String> entry : fieldMap.entrySet()) {
				...
				// 获取当前单元格中的内容
				String content = sheet.getCell(col, i+2).getContents().toString().trim();
				// 判断前几列不能为空
				if (index > 0) {
					if (content == null || content.equals("")) {
						throw new CustomException("3," + (col + 1) + "," + (i + 3));
					}
				}
